...
public interface AccountsApi {
    ...
    /**
     * PATCH /accounts/{accountId} : Updates user account
    ...
    @Operation(
        ...
        description = "Updates a users account with the new given details",
        tags = {"Accounts"},
        responses = {
          @ApiResponse(
              responseCode = "200", description = "User account updated", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AccountDto.class))
              }),
          @ApiResponse(responseCode = "400", description = "Bad request", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class))
    ...
    @RequestMapping(
        ...
        produces = {"application/json"},
        consumes = {"application/json"})
    default ResponseEntity<AccountDto> updateUserAccount(
        @PathVariable String accountId, @Valid @RequestBody AccountDto accountDto) {
      return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }
